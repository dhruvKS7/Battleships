...
This class, when called, creates a boolean to tell the user if the space is open or not
 */

package saligrambattleship;

public class CruiserReturn {
    ...
    public static boolean placement(String coordinateInput, String orientation, boolean[][] coordinateTester) {
        ...
        //Creating and setting flag below:
        boolean flag;
        flag = false;
        ...
        //Returning boolean to tell user if space is open or not below:
        return flag;
    }
}
