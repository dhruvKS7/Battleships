...
This class, when accessed, updates the player's board to show them on the screen where they placed their cruiser
 */
...
public class CruiserLabelPlacement {
    ...
    public static JLabel[][] placement(String coordinateInput, String orientation, boolean[][] coordinateTester, JLabel[][] board) {
        ...
        //Creating and setting spacer and flag below:
        ...
        if (coordinateInput.charAt(0) == 'A') {
            ...
            if (orientation.equals("H")) {
                ...
                } else if (coordinateInput.equals("H8")) {
                    //Testing to see if a ship has already been placed in the same region below:
                    for (int a = 7; a < 10; a++) {
                        if (coordinateTester[a][7] == true) {
                            flag = true;
                ...
                } else if (coordinateInput.equals("H9")) {
                    //Testing to see if a ship has already been placed in the same region below:
                    for (int a = 7; a < 10; a++) {
                        if (coordinateTester[a][8] == true) {
                            flag = true;
                ...
                } else if (coordinateInput.equals("H10")) {
                    //Testing to see if a ship has already been placed in the same region below:
                    for (int a = 7; a < 10; a++) {
                        if (coordinateTester[a][9] == true) {
                            flag = true;
            ...
            if (orientation.equals("V")) {
                ...
                } else if (coordinateInput.equals("I8")) {
                    //Testing to see if a ship has already been placed in the same region below:
                    for (int a = 7; a < 10; a++) {
                        if (coordinateTester[8][a] == true) {
                            flag = true;
            ...
            if (orientation.equals("V")) {
                ...
                } else if (coordinateInput.equals("J8")) {
                    //Testing to see if a ship has already been placed in the same region below:
                    for (int a = 7; a < 10; a++) {
                        if (coordinateTester[9][a] == true) {
                            flag = true;
        ...
        //Returning JLabel 2D array to show user where they placed their cruiser on the board below:
        return board;
    }
}
